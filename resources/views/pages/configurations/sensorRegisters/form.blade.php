                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="sensor_type" class="form-control select2bs4 @error('sensor_type_id') input-error @enderror" name="sensor_type_id" style="width: 100%">
                                        ...
                                        @foreach($sensorTypes as $sensorType)
                                            <option value="{{ $sensorType->id }}" {{isset ($sensorRegister) ? ($sensorType->id == $sensorRegister->sensor_type_id ? "selected" : '') : '' }}> {{ $sensorType->description }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="sensor_model" class="form-control select2bs4 @error('sensor_model_id') input-error @enderror" name="sensor_model_id" style="width: 100%">
                                        <option value="" selected disabled>Select Sensor Model</option>

                                        @foreach($sensorModels as $sensorModel)
                                            <option value="{{ $sensorModel->id }}" {{isset ($sensorRegister) ? ($sensorModel->id == $sensorRegister->sensor_model_id ? "selected" : '') : '' }}> {{ $sensorModel->sensor_model }}</option>
                                        @endforeach
                                    </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('sensor_reg_address') input-error @enderror" id="sensorRegisterAddress"
                                            name="sensor_reg_address"
